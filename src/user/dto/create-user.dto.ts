...
export class CreateUserDto {
  ...
  @ApiProperty({ description: '微信openid', example: '', required: false })
  openid?: string; //openid, 微信登陆生成账号时候使用

  @ApiProperty({ description: '微信sessionkey', example: '', required: false })
  sessionkey?: string; //sessionkey, 微信登陆时候生成
}
